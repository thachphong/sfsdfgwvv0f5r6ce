...
namespace QLNhiemvu_WebAPI.Functions
{
    public partial class ResourceManager : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (name.ToLower())
            {
                ...
                case "td_thamdinh_duyet_tepdinhkem":
                    ...
                    break;
                case "td_pheduyetnhiemvuvb_tepdinhkem":
                    Trinhduyet_PheduyetVB_Tepdinhkem();
                    break;
                case "td_pheduyetnhiemvutd_tepdinhkem":
                    Trinhduyet_PheduyetTD_Tepdinhkem();
                    break;
            }
        }

        private void Trinhduyet_PheduyetTD_Tepdinhkem()
        {
            ...
            string folderPath = ResolveUrl(Defines.ResourcePaths.TrinhduyetPheduyet.Tepdinhkem_TD);
        ...
        private void Trinhduyet_PheduyetVB_Tepdinhkem()
        {
            string fn = Request.QueryString["fn"];
            if (string.IsNullOrEmpty(fn))
                fn = DateTime.Now.Ticks.ToString();
            ...
            string folderPath = ResolveUrl(Defines.ResourcePaths.TrinhduyetPheduyet.Tepdinhkem_VB);
            if (!Directory.Exists(MapPath(folderPath)))
                Directory.CreateDirectory(MapPath(folderPath));
